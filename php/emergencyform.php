...
if (isset($_POST['user_id'], $_POST['service_id'], $_POST['vendor_id'], $_POST['city'], $_POST['address'], $_POST['description'], $_POST['image'])) {
    ...
    try {
        ...
        $stmt = $db->prepare("INSERT INTO booking_emergency (user_id, service_id, vendor_id, city, address, description, image) VALUES (:user_id, :service_id, :vendor_id, :city, :address, :description, :image)");
