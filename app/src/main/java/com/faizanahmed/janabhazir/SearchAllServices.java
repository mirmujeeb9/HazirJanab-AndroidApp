...
//        });
    ...
    private void fetchItemsFromDatabase() {
        String url = "http://192.168.100.17:100/hazirjanab/item.php"; // Replace with your server URL for fetching item data
    ...
    public void onItemClicked(int position) {
        ...
        if (filteredList.isEmpty()) {
            ...
            intent.putExtra("serviceType", filteredList.get(position).getItemType());
        }
